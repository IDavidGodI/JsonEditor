  ...
  return ( 
    <form className="p-4 h-full *:my-2 relative">
      <div className="flex justify-end w-full">
        <Button type="button" className="absolute w-auto h-auto text-xs top-0 z-50 shadow-lg bg-gray-500 hover:bg-gray-600" onClick={toggleForm} >close form</Button>
      </div>
      <div className="flex gap-x-12 p-2 pt-3">
        <div className="w-1/2">

          <JsonDrop<ThemeFields> setFile={setMainFile} placeholder="Upload main setup file"/>
        </div>
        <div className="w-1/2">
